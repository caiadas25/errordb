...
export const metadata: Metadata = {
  ...
  description:
    "Searchable database of programming error messages. Plain-English explanations, common causes, and working fixes for JavaScript, TypeScript, Python, Node.js, React, Java, Go, Rust, Kotlin, Git, Docker, SQL, and more.",
  openGraph: {
    title: "ErrorDB — Programming Error Messages Explained",
    description:
      "Plain-English explanations, causes, and fixes for programming errors across JavaScript, TypeScript, Python, Node.js, React, Java, Go, Rust, Kotlin, Git, Docker, SQL, and more.",
    siteName: "ErrorDB",
    type: "website",
  },
  twitter: {
