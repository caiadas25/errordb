...
export const metadata: Metadata = {
  ...
  metadataBase: new URL("https://errordb.vercel.app"),
  openGraph: {
    title: "ErrorDB — Programming Error Messages Explained",
    description:
      "Plain-English explanations, causes, and fixes for programming errors across JavaScript, TypeScript, Python, Ruby, Node.js, React, Java, Go, Rust, Kotlin, Swift, Git, Docker, SQL, and more.",
    siteName: "ErrorDB",
    type: "website",
  },
  twitter: {
